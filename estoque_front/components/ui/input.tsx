...
export const inputVariants = cva(
  " w-full   bg-background  border-default-300 dark:border-700  px-3 h-10 text-base  file:border-0 file:bg-transparent file:text-base file:font-medium  read-only:leading-10 read-only:bg-background  disabled:cursor-not-allowed disabled:opacity-50  transition duration-300 ",
  {
    variants: {
      color: {
        default:
